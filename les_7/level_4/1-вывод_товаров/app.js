...
let productsShowed = document.querySelector(".products");
...
function showCategory(category) {
    ...
    productsCategory.forEach(function (product) {
        productsAdd += getProductMarkup(product);
    });

    productsShowed.insertAdjacentHTML("afterbegin", productsAdd);
}
